    ...
    return (
        <div className="container ">
            <div className=' row p-5 mt-5 '>
                <h2 className='fs-2 d-flex justify-content-center align-items-center text-muted'>We pioneered the discount broking model in India. <br />
                    Now, we are breaking ground with our technology.
                </h2>
            </div>
            <div className="row p-5 fs-5 mt-5 border-top text-muted" >
